class Student():
    ...
    def __init__(self,fName:str,lName:str,major:str,credit_hours:int,gpa:float,id_Number):
        self.__fName = fName
        self.__lName = lName
        self.__major = major
    ...
    def print_data(self):
        print(f"-----------")
        print(f"{self.get_fName()} {self.get_lName()}")
        print(f"Class Level: {self.get_class_level()}, Major: {self.get_major()}")
        print(f"GPA:{self.get_gpa()}, ID:{self.get_id_number()}")
